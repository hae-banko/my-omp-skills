...
<p align="center">
  <img src="https://img.shields.io/badge/version-0.54.0-8A2BE2" alt="version" />
...
```bash
omp plugin install "git+https://github.com/hae-banko/my-omp-skills.git#v0.54.0"
```

Or via SSH:

```bash
omp plugin install "git@github.com:hae-banko/my-omp-skills.git#v0.54.0"
```
